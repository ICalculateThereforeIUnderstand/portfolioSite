...
function TrecaStranica() {
	...
	React.useEffect(() => {   
        if (jezik == "en") {
	        ...
	        setData7({"naslov": "HTML PANG", "jezik": "JAVASCRIPT/SCSS", "naslovSize": 17, "slikaUrl": "./slike/pang.jpg", modalID: "modal-el7",
	        "panelNaslov": "HTML PANG", "panelNaslov1": "JavaScript/SCSS", "panelTekst": "The goal of this project was to make replica of my favorite arcade game of childhood - The Pang. Similarly to Tetris, this game is possible utilising only HTML+CSS graphics plus game engine in JavaScript. For the beginning, I have implemented simpler 'panic mode' of game, where balls are showing up regularly and falling into screen from its upper edge. One day I plan to continue developing this game, and plan to implement different levels of game's non-panic normal mode where player flies accross the world's map to different cities and each level has different layout of platforms he can walk on, ladders, bonuses, three types of weapons, etc.",
	        "siteUrl": "https://savicslobodan.com/html_pang", "stranice": [Page19]});
